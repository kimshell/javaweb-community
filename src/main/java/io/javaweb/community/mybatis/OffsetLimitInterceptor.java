package io.javaweb.community.mybatis;
...
import io.javaweb.community.mybatis.dialect.Dialect;
...
import io.javaweb.community.mybatis.support.PropertiesHelper;
import io.javaweb.community.mybatis.support.SQLHelp;
...
public class OffsetLimitInterceptor implements Interceptor{
	...
	private <T> Future<T> call(@SuppressWarnings("rawtypes") Callable callable, boolean async){
        if(async){
